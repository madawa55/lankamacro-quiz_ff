...
export const QUESTIONS: Question[] = [
  ...
  {
    id: 1,
    round: Round.THINK_AGAIN,
    text: "Which of the following is most likely to cause an energy crash after a meal?",
    options: ["Whole wheat bread", "White rice with chicken curry", "Kottu with chicken and vegetables", "A banana with peanut butter"],
    correctAnswer: 1,
    ...
    visualPrompt: "Image of white rice with curry showing a sugar spike vs a banana with peanut butter showing stable energy."
  },
  {
    id: 2,
    round: Round.THINK_AGAIN,
    text: "Which food is best for muscle recovery after exercise?",
    options: ["Fish curry with rice", "Coconut roti with sambol", "Lean chicken with salad", "Watalappam (sweet dessert)"],
    correctAnswer: 2,
    ...
    visualPrompt: "Image of lean chicken with salad vs Watalappam with calories and nutrients labeled."
  },
  {
    id: 3,
    round: Round.THINK_AGAIN,
    text: "Which of the following provides the best balance of protein, carbs, and fats?",
    options: ["Hoppers with coconut milk", "Rice and dhal with a side of curry", "Fried chicken with chips", "Fresh fruit salad"],
    correctAnswer: 1,
    ...
    visualPrompt: "Image of rice and dhal with curry vs fried chicken with chips showing protein-carb-fat balance."
  },
  {
    id: 4,
    round: Round.THINK_AGAIN,
    text: "What is the best way to ensure your diet supports long-term health?",
    options: ["Eating more refined sugars", "Balancing carbs, protein, and fats", "Drinking soft drinks", "Fasting regularly"],
    correctAnswer: 1,
    ...
    visualPrompt: "Image of balanced meal (protein, carbs, fats) vs extreme diets (sugary foods)."
  },
  {
    id: 5,
    round: Round.THINK_AGAIN,
    text: "How many times this week did you order takeout or fast food?",
    options: ["1–2 times", "3–4 times", "5+ times", "I never order takeout"],
    correctAnswer: 2,
    ...
    visualPrompt: "Image of fast food (pizza, burger) with calorie breakdown. Bar chart comparing home-cooked meals vs fast food calories."
  },
  // Round 2: REALITY CHECK
  {
    id: 6,
    round: Round.REALITY_CHECK,
    text: "Which of these meals is likely higher in calories?",
    options: ["A plate of Kottu Roti", "A bowl of string hoppers with sambol", "A small serving of rice and curry with chicken", "A plate of vegetable curry with rice"],
    correctAnswer: 0,
    ...
    visualPrompt: "Kottu roti with oil splashes vs rice and curry with chicken, showing calorie comparison."
  },
  {
    id: 7,
    round: Round.REALITY_CHECK,
    text: "Which of these snacks is the most calorie-dense?",
    options: ["Nuts and seeds", "Fresh fruit", "Chocolate biscuits", "Vegetable salad"],
    correctAnswer: 2,
    ...
    visualPrompt: "Image of nuts and seeds vs chocolate biscuits, with calories labeled."
  },
  {
    id: 8,
    round: Round.REALITY_CHECK,
    text: "Which drink is most likely contributing to weight gain?",
    options: ["Fresh fruit juice with added sugar", "Black coffee", "Green tea", "Water"],
    correctAnswer: 0,
    ...
    visualPrompt: "Image of fruit juice with sugar vs water and green tea, with sugar content highlighted."
  },
  {
    id: 9,
    round: Round.REALITY_CHECK,
    text: "Which is the better option for a quick energy boost at work?",
    options: ["A sugary energy drink", "A handful of mixed nuts with a piece of fruit", "A chocolate bar", "A second cup of coffee"],
    correctAnswer: 1,
    ...
    visualPrompt: "Mixed nuts and fruit vs sugary drinks. Energy chart showing steady energy from nuts and fruit."
  },
  {
    id: 10,
    round: Round.REALITY_CHECK,
    text: "What is the healthiest snack option during a long workday?",
    options: ["Cookies", "A piece of fruit with a small handful of almonds", "Chips", "Pastries"],
    correctAnswer: 1,
    ...
    visualPrompt: "Fruit and almonds vs cookies, chips, and pastries."
  },
  // Round 3: MACRO INTELLIGENCE
  {
    id: 11,
    round: Round.MACRO_INTELLIGENCE,
    text: "What’s the main role of protein in your diet?",
    options: ["To provide quick energy", "To build and repair muscles", "To increase fat storage", "To keep you hydrated"],
    correctAnswer: 1,
    ...
    visualPrompt: "Image of protein-rich foods (chicken, eggs, lentils) with muscle-building icons."
  },
  {
    id: 12,
    round: Round.MACRO_INTELLIGENCE,
    ...
    visualPrompt: "Image of lean protein sources (chicken, beans) with muscle-building icons."
  },
  {
    id: 13,
    round: Round.MACRO_INTELLIGENCE,
    text: "What’s the best way to balance macros for a healthy fat-loss goal?",
    options: ["High protein, moderate fats, low carbs", "High carbs, moderate protein, low fats", "Balanced protein, carbs, fats", "Low protein, high fats"],
    correctAnswer: 0,
